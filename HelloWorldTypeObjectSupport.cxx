        ...
        TypeIdentifierPair& type_ids_HelloWorld)
{
    ...
    if (eprosima::fastdds::dds::RETCODE_OK != return_code_HelloWorld)
    {
        ...
        }
        {
            ...
            ann_custom_HelloWorld.reset();
            CompleteMemberDetail detail_timestamp = TypeObjectUtils::build_complete_member_detail(name_timestamp, member_ann_builtin_timestamp, ann_custom_HelloWorld);
            CompleteStructMember member_timestamp = TypeObjectUtils::build_complete_struct_member(common_timestamp, detail_timestamp);
            TypeObjectUtils::add_complete_struct_member(member_seq_HelloWorld, member_timestamp);
        }
